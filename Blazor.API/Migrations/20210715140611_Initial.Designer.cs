...
namespace Blazor.API.Migrations
{
    ...
    [Migration("20210715140611_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blazor.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("Blazor.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("Blazor.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Blazor.Domain.Employee", b =>
                {
                    b.HasOne("Blazor.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blazor.Domain.JobCategory", "JobCategory")
                        .WithMany()
